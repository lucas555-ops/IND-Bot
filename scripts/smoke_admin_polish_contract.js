...
for (const fragment of ['👑 Админка', 'Чистый founder/operator root', 'Готовы, но не опубликованы: 11', 'Уведомление: активно']) {
...
for (const fragment of ['🧰 Операции', 'Пользовательская воронка', 'Проблемы доставки: 4']) {
